...
\hline
{\em int} & years years of employment \\
\hline
{\em double} & hourly\+Rate rate of pay hourly \\
\hline
...
\begin{DoxyPrecond}{Precondition}
hourly\+Rate and years are stored 
\end{DoxyPrecond}
\begin{DoxyReturn}{Returns}
void 
\end{DoxyReturn}
\begin{DoxyPostcond}{Postcondition}
hourly\+Rate is increased and employee is congratulated 
\end{DoxyPostcond}
...
\begin{DoxyPrecond}{Precondition}
data is stored in hourly\+Rate and hours\+Worked 
\end{DoxyPrecond}
\begin{DoxyReturn}{Returns}
virtual 
\end{DoxyReturn}
\begin{DoxyPostcond}{Postcondition}
double of employee\textquotesingle{}s pay 
\end{DoxyPostcond}
